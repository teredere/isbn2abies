#--- script de recuperación para pus (catalogo.pusc.it:22210/biblios) ------------------------------
# argumentos: 1) ISBN, 2) Nº secuencial (para nombrar salida)
#
# dirmarc =	archivos_marc21
# ext     =	mrc
# TARGET:pus, catalogo.pusc.it:22210/biblios, marc21, utf8, -, -, 
#--------------------------------------------------------------------------------
outfile=archivos_marc21/$1.pus.$2.mrc
rm -f TMPMRC TMPRESULT TMPUNEXPECTED $outfile
yaz-client -m TMPMRC <<xfinx  >TMPRESULT
charset utf8
open catalogo.pusc.it:22210/biblios
f @attr 1=7 $1
format marc21
s 1
exit
