#--- script de recuperación para nla (catalogue.nla.gov.au:7090/voyager) ------------------------------
# argumentos: 1) ISBN, 2) Nº secuencial (para nombrar salida)
#
# dirmarc =	archivos_marc21
# ext     =	mrc
# TARGET:nla, catalogue.nla.gov.au:7090/voyager, marc21, utf8, -, -
#--------------------------------------------------------------------------------
outfile=archivos_marc21/$1.nla.$2.mrc
rm -f TMPMRC TMPRESULT TMPUNEXPECTED $outfile
yaz-client -m TMPMRC <<xfinx  >TMPRESULT
charset utf8
open catalogue.nla.gov.au:7090/voyager
f @attr 1=7 $1
format marc21
s 1
exit
