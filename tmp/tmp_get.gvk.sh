#--- script de recuperación para gvk (z3950.k10plus.de:210/gvk) ------------------------------
# argumentos: 1) ISBN, 2) Nº secuencial (para nombrar salida)
#
# dirmarc =	archivos_marc21
# ext     =	mrc
# TARGET:gvk, z3950.k10plus.de:210/gvk, marc21, utf8, -, -
#--------------------------------------------------------------------------------
outfile=archivos_marc21/$1.gvk.$2.mrc
rm -f TMPMRC TMPRESULT TMPUNEXPECTED $outfile
yaz-client -m TMPMRC <<xfinx  >TMPRESULT
charset utf8
open z3950.k10plus.de:210/gvk
f @attr 1=7 $1
format marc21
s 1
exit
